...
float
Color::intToHue( unsigned int val )
{
...
Colorf
Color::hsvToRgb( const Colorf & hsv )
{
  Colorf rgb;
  rgb[3] = hsv[3];
...
Colorf
Color::rgbToHsv( const Colorf & rgb ) {
  Colorf hsv;
  hsv[3] = rgb[3];
...
Colorf
Color::intToRgb( unsigned int val )
{
...
unsigned int
Color::rgbToInt( const Colorf & rgb ) {
...
unsigned int
Color::rgbToInt( const Colord & rgb ) {
...
Colorf
Color::roundRgb( const Colorf & rgb ) {
  Colorf result;
  for ( int i = 0; i < 4; ++i )
